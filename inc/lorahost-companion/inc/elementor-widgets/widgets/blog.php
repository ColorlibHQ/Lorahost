...
/**
 *
 * lorahost elementor few words section widget.
 *
 * @since 1.0
 */

class Lorahost_Blog extends Widget_Base {

	public function get_name() {
		return 'lorahost-blog';
	}

	public function get_title() {
		return __( 'Blog', 'lorahost' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'blog_content',
            [
                'label' => __( 'Blog', 'lorahost' ),
            ]
        );
        $this->add_control(
            'blog_limit',
            [
                'label'   => esc_html__( 'Post Limit', 'lorahost' ),
        ...
        $this->add_control(
            'color_blogtitle', [
                'label'     => __( 'Blog Title Color', 'lorahost' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#05364d',
                'selectors' => [
        ...
        $this->add_control(
            'color_blogtitlehov', [
                'label'     => __( 'Blog Title Hover Color', 'lorahost' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'color_blogtext', [
                'label'     => __( 'Blog Meta Color', 'lorahost' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#797979',
                'selectors' => [
        ...
        $this->add_control(
            'content_bg', [
                'label'     => __( 'Blog Content Background Color', 'lorahost' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#f8faff',
                'selectors' => [
        ...
        $this->add_control(
            'hover_content_bg', [
                'label'     => __( 'Hover Content Background Color', 'lorahost' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'btn_border', [
                'label' => esc_html__('Button Border Style', 'lorahost'),
		...
		$this->add_control(
            'btnhover_border', [
                'label' => esc_html__('Button Hover Border Style', 'lorahost'),
                'type'  => Controls_Manager::HEADING
            ]
        );
		$this->add_group_control(
        ...
        <section class="blog-area section-gap">
            <div class="container">
                ...
                <div class="row">
	                <?php
	                // Blog
	                lorahost_blog_section( $settings['blog_limit'] );
	                ?>
                </div>
            </div>
        </section>
