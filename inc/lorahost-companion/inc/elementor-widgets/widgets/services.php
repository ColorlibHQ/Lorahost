 ...
 * @since 1.0
 */
class Lorahost_Services extends Widget_Base {

	public function get_name() {
		return 'lorahost-services';
	}

	public function get_title() {
		return __( 'Services', 'lorahost' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'services_heading',
            [
                'label' => __( 'Services Section Heading', 'lorahost' ),
            ]
        );
        $this->add_control(
            'sect_title', [
                ...
                'label_block' => true,
                'default'   => __('What Service We <br> Offer For You', 'lorahost')
        ...
        $this->add_control(
            'sect_subtitle', [
                ...
                'type'  => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__('Our service', 'lorahost')
		...
		$this->start_controls_section(
			'services_block',
			[
				'label' => __( 'Services', 'lorahost' ),
			]
		);
		$this->add_control(
            'services_content', [
                'label' => __( 'Create Service Item', 'lorahost' ),
                ...
                'fields' => [
                    [
                        ...
                        'type'  => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default' => esc_html__('Web Development', 'lorahost')
                    ],
                    [
                        'name'  => 'desc',
	                ...
	                [
		                ...
		                'type'  => Controls_Manager::TEXT,
		                'label_block' => true,
		                'default' => esc_html__('learn More', 'lorahost')
	                ],
                    [
		                'name'  => 'btnurl',
        ...
        $this->start_controls_section(
            'style_section', [
                'label' => __( 'Style Section Heading', 'lorahost' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'color_secttitle', [
                'label'     => __( 'Section Title Color', 'lorahost' ),
        ...
        $this->add_control(
            'color_sectsubtitle', [
                'label'     => __( 'Section Sub Title Color', 'lorahost' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#797979',
                'selectors' => [
        ...
        $this->add_control(
            'subtitle_border', [
                'label'     => __( 'Sub Title Border Color', 'lorahost' ),
                'type'      => Controls_Manager::COLOR,
        ...
        $this->start_controls_section(
            'style_trainingbox', [
                'label' => __( 'Style Services Content', 'lorahost' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'service_hover_title', [
                'label' => __( 'Title Hover Color', 'lorahost' ),
                'type'  => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'service_bg_color', [
                'label' => __( 'Service Background Color', 'lorahost' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'service_hover_bg_color', [
                'label' => __( 'Service Hover Background Color', 'lorahost' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'service_hover_desc_color', [
                'label' => __( 'Description Hover Color', 'lorahost' ),
                'type'  => Controls_Manager::COLOR,
                'selectors' => [
		...
		$this->add_control(
			'btn_label_color', [
				'label' => __( 'Service Button Label Color', 'lorahost' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'service_btn_setting',
			[
				'label'     => __( 'Button Border Color', 'lorahost' ),
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Button Hover Border Color', 'lorahost' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
                            ...
                            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                                <div class="service_item">
                                    ...
                                    if( !empty( $service['img']['url'] ) ){
                                        echo '<img src="'. esc_url( $service['img']['url'] ) .'" alt="'. esc_html__('service feature image', 'lorahost') .'">';
                                    }
