...
// image default alt
if( ! function_exists( 'lorahost_img_default_alt' ) ) {
	function lorahost_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'lorahost_img_tag' ) ) {
	function lorahost_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = lorahost_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'lorahost_anchor_tag' ) ) {
	function lorahost_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'lorahost' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'lorahost_heading_tag' ) ) {
	function lorahost_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'lorahost' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'lorahost_paragraph_tag' ) ) {
	function lorahost_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'lorahost_other_tag' ) ) {
	function lorahost_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'lorahost_button_element ' ) ) {
	function lorahost_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'lorahost' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
