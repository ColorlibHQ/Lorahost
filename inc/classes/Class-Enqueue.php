...
class lorahost_Enqueue {

	public $scripts = array();

	public function lorahost_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'lorahost_frontend_enqueue_scripts', ) );
	}

	public function lorahost_frontend_enqueue_scripts( ) {
